...
The golden set contains fourteen stratified questions. It covers complete answers,
...
| --- | ---: | --- |
| Mapping accuracy | 1.00 | Expected profile selected for 14/14 questions |
| Status accuracy | 1.00 | Expected answer status returned for 14/14 questions |
...
These results validate the MVP wiring, not production generalisation. Fourteen questions
